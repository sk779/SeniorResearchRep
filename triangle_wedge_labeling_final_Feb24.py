...
#print charu6
#
#print sorted(charu1, key=itemgetter(1), reverse=True)
#print sorted(charu2, key=itemgetter(0,1))

print [charu2[0][0],charu2[0][1]]


#print sorted(charu4, cmp=my_compare_c4)
#print sorted(charu5, key=itemgetter(0,1), reverse=True)
#print "charu 6"
