...
#            y_prime_old = y_prime
        ...
        y_prime_old = y_prime
        print x_prime, y_prime, i_loop, pt_num, i_loop/pt_num, (float)(i_loop/pt_num)
...
#plt.hexbin(x_list, y_list, C=val_list, gridsize=gridsize, linewidths=1, cmap=CM.jet, bins=None)
#plt.axis([0, 100, 0, 100])

#plt.scatter(x_list, y_list, c=val_list,marker=(6, 0, 90), s=5000)
